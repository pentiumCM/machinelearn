    ...
    for setsubdir in set_dirs:
        ...
        if setsubdir[:3] == 'set':
            ...
            for vsubdir in vdirs:
                ...
                vfiles = os.listdir(vsubdir_path)
                for imgfile in vfiles:
                    # img - in路径
...
#     imgin = 'F:/experiment/Caltech/VOC_process/JPEGImages_test'
#     imgout = 'F:/experiment/Caltech/VOC_process/JPEGImages_test_out'
